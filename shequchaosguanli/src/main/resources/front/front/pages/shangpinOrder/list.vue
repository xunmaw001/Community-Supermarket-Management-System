				...
				<view class="bg-white margin-sm padding-sm solids-bottom radius text-content">
					<view class="flex justify-between">
						<view class="text-bold" style="flex-shrink: 0;">
							<text class="text-red">{{ item.shangpinOrderTypes == 1?item.shangpinOrderValue:'' }}</text>
							<text class="text-green">{{ item.shangpinOrderTypes == 2?item.shangpinOrderValue:'' }}</text>
					...
					<view class="flex justify-end" style="font-size: 24upx;">
						<view v-if="item.shangpinOrderTypes == 2">
							<view @tap="onCancelTap(item)" class="round cu-btn lines-grey mid  margin-right-sm">退款</view>
						</view>
						<view v-if="item.shangpinOrderTypes == 3">
							<view @tap="onshouhuoTap(item.id)" class="round cu-btn lines-grey mid  margin-right-sm">收货</view>
						</view>
						<view v-if="item.shangpinOrderTypes == 4">
							<view @tap="onChatTap(item.id)" class="round cu-btn lines-grey mid  margin-right-sm">评价</view>
						</view>
					</view>
				</view>
			</view>
