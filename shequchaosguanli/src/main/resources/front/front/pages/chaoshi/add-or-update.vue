	...
	<view class="content">
		<form class="app-update-pv">
            ...
            <view
                    ...
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'
                      class="title">超市管理姓名</view>
                <input   readonly="readonly"
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.chaoshiName" type="text" v-model="ruleForm.chaoshiName" placeholder="超市管理姓名"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                ...
                <input   readonly="readonly"
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.chaoshiPhone" type="text" v-model="ruleForm.chaoshiPhone" placeholder="联系方式"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"rgba(0, 102, 51, 1)","textAlign":"left"}'
                      class="title">身份证号</view>
                <input   readonly="readonly"
                         :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0, 102, 51, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"28rpx","borderStyle":"solid","height":"68rpx"}'
                         :disabled="ro.chaoshiIdNumber" type="text" v-model="ruleForm.chaoshiIdNumber" placeholder="身份证号"></input>
            </view>
                <view :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"88rpx"}'
                    ...
                    <picker @change="sexTypesChange" :value="sexTypesIndex" :range="sexTypesOptions" range-key="indexName">
                        <view
                                :style='{"borderColor":"rgba(0, 102, 51, 1)","backgroundColor":"rgba(248, 248, 248, 1)","borderRadius":"0px","color":"rgba(0, 102, 51, 1)","textAlign":"left","borderWidth":"0 0 6rpx","fontSize":"24rpx","borderStyle":"solid","height":"80rpx"}'
	...
	export default {
		...
		/*下拉框*/
			...
			if (options.id) {
				...
				// 获取信息
				let res = await this.$api.info(`chaoshi`, this.ruleForm.id);
				this.ruleForm = res.data;
                uni.setStorageSync('chaoshiState', true);
			}
			// 跨表
			// this.styleChange()
		},
		methods: {
			...
			async onSubmitTap() {
				...
				if ((!this.ruleForm.chaoshiName)) {
					this.$utils.msg(`超市管理姓名不能为空`);
					return
				}
				if ((!this.ruleForm.chaoshiPhone) && (!this.$validate.isMobile(this.ruleForm.chaoshiPhone))) {
					this.$utils.msg(`联系方式不能为空并且需要输入正确格式`);
					return
				}
				if ((!this.ruleForm.chaoshiIdNumber) && (!this.$validate.checkIdCard(this.ruleForm.chaoshiIdNumber))) {
                    this.$utils.msg(`身份证号不能为空并且需要输入正确格式`);
                    return
                }
				...
				if (this.ruleForm.id) {
					await this.$api.update(`chaoshi`, this.ruleForm);
				} else {
					await this.$api.save(`chaoshi`, this.ruleForm);
				}
