...
<template>
	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
		...
		<view class="search-form round">
			...
			<input v-model="searchForm.shangpinCollectionName" type="text" placeholder="商品收藏名称"></input>
		</view>
		<view class="action">
			<button @tap="search"
	...
	export default {
		...
		methods: {
			...
			async search() {
				...
				if (this.searchForm.shangpinCollectionName) {
					searchForm['shangpinCollectionName'] = this.searchForm.shangpinCollectionName
				}
				let res = await this.$api.list(`shangpinCollection`, searchForm);
				// 如果是第一页数据置空
