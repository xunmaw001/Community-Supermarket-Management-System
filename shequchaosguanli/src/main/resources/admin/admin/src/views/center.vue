<template>
  <div>
    ...
    >  
     <el-row>
                    <el-col :span="12">
           <el-form-item v-if="flag=='chaoshi'"  label='超市管理姓名' prop="chaoshiName">
               <el-input v-model="ruleForm.chaoshiName"  placeholder='超市管理姓名' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='chaoshi'"  label='联系方式' prop="chaoshiPhone">
               <el-input v-model="ruleForm.chaoshiPhone"  placeholder='联系方式' clearable></el-input>
           </el-form-item>
         </el-col>

         <el-col :span="12">
           <el-form-item v-if="flag=='chaoshi'"  label='身份证号' prop="chaoshiIdNumber">
               <el-input v-model="ruleForm.chaoshiIdNumber"  placeholder='身份证号' clearable></el-input>
           </el-form-item>
         </el-col>
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
                         if((!this.ruleForm.chaoshiName)&& 'chaoshi'==this.flag){
                             this.$message.error('超市管理姓名不能为空');
                             return
                         }

                         if((!this.ruleForm.chaoshiPhone)&& 'chaoshi'==this.flag){
                             this.$message.error('联系方式不能为空');
                             return
                         }

                         if((!this.ruleForm.chaoshiIdNumber)&& 'chaoshi'==this.flag){
