    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="计量单位" prop="shangpinJiliang">
                        <el-input v-model="shangpinForm.shangpinJiliang"
                                  placeholder="计量单位" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="计量单位" prop="shangpinJiliang">
                            <el-input v-model="ruleForm.shangpinJiliang"
            ...
            <input id="shangpinId" name="shangpinId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="出入库时间" prop="shangpinchurukuNumber">
                       <el-input v-model="ruleForm.shangpinchurukuNumber"
                                 placeholder="出入库时间" clearable  :readonly="ro.shangpinchurukuNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="出入库时间" prop="shangpinchurukuNumber">
                           <el-input v-model="ruleForm.shangpinchurukuNumber"
                                     placeholder="出入库时间" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="shangpinchurukuTypes">
                        <el-select v-model="ruleForm.shangpinchurukuTypes" placeholder="请选择类型">
                            <el-option
                                v-for="(item,index) in shangpinchurukuTypesOptions"
                    ...
                    <div v-else>
                        <el-form-item class="input" label="类型" prop="shangpinchurukuValue">
                        <el-input v-model="ruleForm.shangpinchurukuValue"
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    shangpinId: false,
                    shangpinchurukuNumber: false,
                    shangpinchurukuTypes: false,
                },
                ruleForm: {
                    shangpinId: '',
                    shangpinchurukuNumber: '',
                    shangpinchurukuTypes: '',
                },
                shangpinchurukuTypesOptions : [],
                shangpinOptions : [],
                rules: {
                   shangpinId: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=shangpinchuruku_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.shangpinchurukuTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinchurukuNumber'){
                          this.ruleForm.shangpinchurukuNumber = obj[o];
                          this.ro.shangpinchurukuNumber = true;
                          continue;
                      }
                      if(o=='shangpinchurukuTypes'){
                          this.ruleForm.shangpinchurukuTypes = obj[o];
                          this.ro.shangpinchurukuTypes = true;
                          continue;
                      }
                    }
                }
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`shangpinchuruku/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.shangpinchurukuCrossAddOrUpdateFlag = false;
                                        this.parent.search();
