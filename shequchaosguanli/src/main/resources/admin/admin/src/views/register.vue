    ...
    <div>
        <div class="container">
            <div class="login-form" style="backgroundColor:rgba(183, 174, 174, 0.5);borderRadius:22px">
                <h1 class="h1" style="color:#000;fontSize:28px;">社区超市管理系统注册</h1>
                <el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
                        ...
                        <el-form-item label="超市管理姓名" class="input" v-if="tableName=='chaoshi'">
                            <el-input v-model="ruleForm.chaoshiName" autocomplete="off" placeholder="超市管理姓名"  />
                        </el-form-item>
                        <el-form-item label="身份证号" class="input" v-if="tableName=='chaoshi'">
                            <el-input v-model="ruleForm.chaoshiIdNumber" autocomplete="off" placeholder="身份证号"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.chaoshiIdNumber)&& 'chaoshi'==this.tableName){
