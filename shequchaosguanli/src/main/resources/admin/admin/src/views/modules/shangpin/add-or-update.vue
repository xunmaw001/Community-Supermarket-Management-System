               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="计量单位" prop="shangpinJiliang">
                       <el-input v-model="ruleForm.shangpinJiliang"
                                 placeholder="计量单位" clearable  :readonly="ro.shangpinJiliang"></el-input>
                   </el-form-item>
                   <div v-else>
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='shangpinJiliang'){
                          this.ruleForm.shangpinJiliang = obj[o];
                          this.ro.shangpinJiliang = true;
                          continue;
                      }
