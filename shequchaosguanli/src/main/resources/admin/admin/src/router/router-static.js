...
import center from '@/views/center'
        ...
        import chaoshi from '@/views/modules/chaoshi/list'
        ...
        import shangpinchuruku from '@/views/modules/shangpinchuruku/list'
        ...
        import dictionaryShangpinchuruku from '@/views/modules/dictionaryShangpinchuruku/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryShangpinchuruku',
        name: '类型',
        component: dictionaryShangpinchuruku
    }
    ,{
    ...
    ,{
        path: '/shangpinchuruku',
        name: '商品出入库',
        component: shangpinchuruku
      }
    ,{
        path: '/yonghu',
        name: '用户',
